...
def create_nat():
        ...
        for row in csv_reader:
            ...
            if not os.path.exists('json_files/' + filename):
                ...
                with open('json_files/' + filename, "r") as file:
                    ...
                    elif "no" in originalSourceGroup:
                ...
                with open('json_files/' + filename, "r") as file:
                    ...
                    if "yes" in originalDestinationGroup:
                    ...
                    elif "no" in originalDestinationGroup:
                ...
                with open('json_files/' + filename, "r") as file:
                    ...
                    if translatedSource != "ignore":
                        ...
                        if "yes" in translatedSourceGroup:
                        ...
                        elif "no" in translatedSourceGroup:
                ...
                with open('json_files/' + filename, "r") as file:
                    ...
                    if translatedDestination != "ignore":
                        ...
                        if "yes" in translatedDestinationGroup:
                        ...
                        elif "no" in translatedDestinationGroup:
    ...
    with open('csv_files/natrules.csv') as csv_file:
        ...
        for row in csv_reader:
            ...
            item_count = 0
            for item in items_list:
                if (items_list[item_count]['name'] == natPolicy):
                    print(item)
                    print("-------------------")
                    containerUUID = items_list[item_count]['id']
                    print(
                        f'NAT Policy, {natPolicy}, UUID is {containerUUID}')
            ...
            if "manual" in ruleType:
                ...
                print(
                    "error in ruleType idenfitication. please check csv file.")
                print(f"ruleType is {ruleType}")
                print("valid options:")
